...
soie die Anzahl der Schiffe fest. Dann beginnt das Spiel.

AUf Grund der Nutzereingaben muss das Spielfeld generiert und die Schiffe versteckt werden. 
Danach wird das Spielfeld angezeigt und der Spieler kann anhand der Koordinaten (d.h. Angabe von Reihe und Spalt) die Schiffe 
versenken. 
Nach jeder Eingabe wird das Spielfeld neu angezeigt. Es wird angzeigt ob er ein Schiff(X) oder Wasser (0) gtroffen hat. 
Gleichzeitig wird es auch schriftlich ausgegeben. 
